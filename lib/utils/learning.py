...
def load_backbone(args):
    model_backbone = DSTformer(dim_in=3, dim_out=3, dim_feat=args.dim_feat, dim_rep=args.dim_rep, 
                               ...
                               num_joints=args.num_joints, maxlen=args.maxlen, norm_layer=partial(nn.LayerNorm, eps=1e-6), 
                               att_fuse=args.att_fuse, res_scale_init_values=args.res_scale_init_values, layer_scale_init_values=args.layer_scale_init_values,
...
#no qkv_bias=True, qk_scale=None, drop_rate=0., attn_drop_rate=0., drop_path_rate=0., 